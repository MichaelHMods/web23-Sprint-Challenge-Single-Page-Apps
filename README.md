...
> Answer: Once the page is loaded it is faster to navigate through the page. The page doesn't fully reload every time, so the interations and changes are faster for the end user. 
